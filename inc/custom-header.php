...
function genius_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'genius_custom_header_args', array(
		'default-image'          => '',
...
if ( ! function_exists( 'genius_header_image' ) ) :
/**
 * Display the custom header image.
 *
 * @since Genius 1.0.0
 */
function genius_header_image() {
	if ( ! get_header_image() ) {
		return;
	}
